                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="tipo_usuario" class="form-control" onchange="cargar_profesor($('#id_user').val(), $('#institucion').val(), this.value )">
                                <option value="0">-Selecciona-</option>
                                @foreach ($tipos as $item)
                                    <option value="{{ $item->int_IdTipoUsuario}}">{{ $item->vch_TipoUsuario}}</option>    
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="institucion" class="form-control" onchange="cargar_profesor($('#id_user').val(), this.value, $('#tipo_usuario').val())">
                                <option value="0">-Selecciona-</option>
                                @foreach ($instituciones as $item)
                                    <option value="{{ $item->int_IdInstitucion}}">{{ $item->name}}</option>    
                                @endforeach
                            </select>
                        </div>
                    </div>
