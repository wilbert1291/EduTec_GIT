...
$('#estado').change(function () {
    if ($(this).val() != 0) {
        $.ajax({
            url: "profesores/combo_municipios/"+$(this).val(),
            type: 'GET',
            dataType: 'html',
            success: function (result) {
                $('#municipio').html('');
...
$('#municipio').change(function () {
    if ($(this).val() != 0) {
        $.ajax({
            url: "profesores/combo_localidades/"+$('#estado').val()+"/"+$(this).val(),
            type: 'GET',
            dataType: 'html',
            success: function (result) {
                $('#localidad').html('');
...
function cargar_municipios(id_municipio) {
    if ($('#estado').val() != 0) {
        $.ajax({
            url: "profesores/combo_municipios/"+$('#estado').val(),
            type: 'GET',
            dataType: 'html',
            success: function (result) {
                $('#municipio').html('');
...
function cargar_localidades(id_municipio, id_localidad) {
    if ($('#municipio').val() != 0) {
        $.ajax({
            url: "profesores/combo_localidades/"+$('#estado').val()+"/"+$('#municipio').val(),
            type: 'GET',
            dataType: 'html',
            data: {
...
$('#btn_guardar').click(function () {
    if (validar('guardar')) {
        $.ajax({
            url: "profesores/insertar/"+ $('#nombre').val() + "/" + $('#ap').val() + "/" + $('#am').val() + "/" + $('#correo').val() + "/" + $('#telefono').val() + "/" + $('#curp').val() + "/" + $('#sexo').val() + "/" + $('#estado').val() + "/" + $('#municipio').val() + "/" + $('#localidad').val() + "/" + $('#calle').val() + "/" + $('#colonia').val() + "/" + $('#codigo_postal').val() + "/" + $('#password').val() + "/" + $('#pregunta_secreta').val() + "/" + $('#respuesta').val() + "/" + $('#acceso').val(),
            method: "GET",
            dataType: 'html',
            success: function (result) {
                if (result==true) {
...
$('#btn_editar').click(function () {
    if (validar('editar')) {
        $.ajax({
            url: "profesores/modificar/"+ $('#id_user').val() + "/" +  $('#nombre').val() + "/" + $('#ap').val() + "/" + $('#am').val() + "/" + $('#correo').val() + "/" + $('#telefono').val() + "/" + $('#curp').val() + "/" + $('#sexo').val() + "/" + $('#estado').val() + "/" + $('#municipio').val() + "/" + $('#localidad').val() + "/" + $('#calle').val() + "/" + $('#colonia').val() + "/" + $('#codigo_postal').val() + "/" + $('#pregunta_secreta').val() + "/" + $('#respuesta').val() + "/" + $('#acceso').val(),
            method: "GET",
            dataType: 'html',
            success: function (result) {
                if (result==true) {
